...
from .service_rent_user import create_rental_record, get_rental_record, list_rental_records, update_rental_record, delete_rental_record, NotFoundError, BadRequestError
from .service_sales_user import create_user_sale, get_user_sale, list_user_sales, patch_user_sale, delete_user_sale, NotFoundError, BadRequestError, replace_user_sale